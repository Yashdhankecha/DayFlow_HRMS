  ...
  return (
    <motion.div variants={container} initial="hidden" animate="show" className="space-y-8">
      ...
      <motion.div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {[{ label: 'Team Attendance', value: '112', icon: <Clock size={24} />, color: 'text-green-400', bg: 'bg-green-400/10' },
          { label: 'Pending Approvals', value: '5', icon: <CalendarDays size={24} />, color: 'text-orange-400', bg: 'bg-orange-400/10' },
          { label: 'Payroll Review', value: '$6.5k', icon: <DollarSign size={24} />, color: 'text-purple-400', bg: 'bg-purple-400/10' }].map((stat, idx) => (
